...
# Bazar
- [The DFIR Report (2021, January 31) Bazar, No Ryuk?](https://thedfirreport.com/2021/01/31/bazar-no-ryuk/)
- [Mandiant (2020, October 28) Unhappy Hour Special: KEGTAP and SINGLEMALT With a Ransomware Chaser](https://www.mandiant.com/resources/kegtap-and-singlemalt-with-a-ransomware-chaser)
- [Palo Alto Networks (2021, May 19) BazarCall Method: Call Centers Help Spread BazarLoader Malware](https://unit42.paloaltonetworks.com/bazarloader-malware/)
- [Palo Alto Networks (2021, October 18) Case Study: From BazarLoader to Network Reconnaissance](https://unit42.paloaltonetworks.com/bazarloader-network-reconnaissance/)
...
- [Elastic (2021, March 16) Detecting Cobalt Strike with memory signatures](https://www.elastic.co/blog/detecting-cobalt-strike-with-memory-signatures)
- [Github Awesome-CobaltStrike-Defence](https://github.com/MichaelKoczwara/Awesome-CobaltStrike-Defence)
- [Mandiant (2021, October 12) Defining Cobalt Strike Components So You Can BEA-CONfident in Your Analysis](https://www.mandiant.com/resources/defining-cobalt-strike-components)
...
- [NCSC (2017, December 15) Keeping your security monitoring effective](https://www.ncsc.gov.uk/blog-post/keeping-your-security-monitoring-effective)
- [Uncoder CTI - fast and easy generation of IOC queries](https://cti.uncoder.io/)
- [Red Canary (2018, May 16) Driving Efficacy Through Detector Tuning: a Deeper Dive Into Detection Engineering](https://redcanary.com/blog/tuning-detectors/)
...
- [CISA (2021, June) Best Practices for MITRE ATT&CK® Mapping](https://us-cert.cisa.gov/sites/default/files/publications/Best%20Practices%20for%20MITRE%20ATTCK%20Mapping.pdf)
- [EU MITRE ATT&CK® Community](https://attack-community.org/)
- [MITRE ATT&CK®](https://attack.mitre.org/)
- [MITRE ATT&CK DEFENDER™](https://mitre-engenuity.org/mad/)
- [MITRE Cyber Analytics Repository](https://github.com/mitre-attack/car)
...
- [Microsoft (2021, October 6) Use attack surface reduction rules to prevent malware infection](https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/attack-surface-reduction?)
...
# Rclone
- [NCC Group (2021, May 27) Detecting Rclone – An Effective Tool for Exfiltration](https://research.nccgroup.com/2021/05/27/detecting-rclone-an-effective-tool-for-exfiltration/)
- [Red Canary (2021, May 4) Transferring leverage in a ransomware attack](https://redcanary.com/blog/rclone-mega-extortion/)

# Remote Administration Tools
- [Red Canary (2021, August 19) Remote access tool or trojan? How to detect misbehaving RATs](https://redcanary.com/blog/misbehaving-rats/)
...
- [win_webshell_detection.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/win_webshell_detection.yml)
- [win_shadow_copies_deletion.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/win_shadow_copies_deletion.yml)
- [sysmon_mal_cobaltstrike.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/pipe_created/sysmon_mal_cobaltstrike.yml)
- [win_whoami_as_system.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/windows/process_creation/win_whoami_as_system.yml)

# Trickbot
- [CISA (2021, March 17) Trickbot Malware](https://us-cert.cisa.gov/sites/default/files/publications/AA21-076A-TrickBot_Malware_508_0.pdf)
- [The DFIR Report (2021, May 2) Trickbot Brief: Creds and Beacons](https://thedfirreport.com/2021/05/02/trickbot-brief-creds-and-beacons/)
- [Kaspersky (2021, October 19) Trickbot module descriptions](https://securelist.com/trickbot-module-descriptions/104603/)

# Vssadmin
- [Red Canary (2019, August 21) It’s all fun and games until ransomware deletes the shadow copies](https://redcanary.com/blog/its-all-fun-and-games-until-ransomware-deletes-the-shadow-copies/)
